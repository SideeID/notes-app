...
function NoteItem({ title, body, createdAt, id, archived, onDelete, onArchive, onUnarchive }) {
    ...
    return (
        <div className={`note-item ${archived ? 'archived' : ''}`}>
            ...
            <div className="button-container">
                ...
                <ArchiveButton onArchive={() => onArchive(id) } onUnarchive={() => onUnarchive(id)} archived={archived}>{archiveButtonText}</ArchiveButton>
            </div>
        </div>
    );
}
